...
const slides = [
  {
    ...
    image: '/bone-meal.png',
    bgColor: 'linear-gradient(270deg, rgba(197, 104, 10, 0.8) 0%, rgba(247, 182, 117, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#000',
  },
  {
    ...
    bgColor: 'linear-gradient(270deg, rgba(190, 150, 3, 0.8) 0%, rgba(242, 214, 113, 0.8) 100%)',
    textColor: '#222',
    btnColor: '#ffff',
    btnTextColor: '#000',
  },
  {
    ...
    bgColor: 'linear-gradient(270deg, rgba(9, 119, 183, 0.8) 0%, rgba(121, 199, 244, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#222',
  },
  {
    ...
    image: '/neem-cake.png',
    bgColor: 'linear-gradient(270deg, rgba(226, 33, 52, 0.8) 0%, rgba(235, 110, 122, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#222',
  },
  {
    ...
    bgColor: 'linear-gradient(270deg, rgba(0, 153, 128, 0.8) 0%, rgba(111, 239, 218, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#222',
  },
  {
    ...
    bgColor: 'linear-gradient(270deg, rgba(230, 119, 1, 0.8) 0%, rgba(246, 186, 123, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#222',
  },
  {
    ...
    image: '/roots-liq.png',
    bgColor: 'linear-gradient(270deg, rgba(135, 2, 71, 0.8) 0%, rgba(248, 121, 187, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#222',
  },
  {
    ...
    bgColor: 'linear-gradient(270deg, rgba(67, 155, 26, 0.8) 0%, rgba(164, 255, 122, 0.8) 100%)',
    textColor: '#000',
    btnColor: '#ffff',
    btnTextColor: '#222',
  },
...
function Hero() {
    ...
    <div>
      ...
      >
        <style jsx>{`
          ...
          .hero-text {
            flex: 1 1 0;
            padding: 2.5rem 2rem 2.5rem 6vw;
            z-index: 2;
        ...
        <div className="hero-slide">
          ...
          <div
            style={{ width: '50%', height: '80vh', padding: '100px ' }}
  ...
  >
    <path
      fill="#fff"
      d="M0,0 C60,60 120,60 180,0 C240,60 300,60 360,0 C420,60 480,60 540,0 C600,60 660,60 720,0 C780,60 840,60 900,0 C960,60 1020,60 1080,0 C1140,60 1200,60 1260,0 C1320,60 1380,60 1440,0 L1440,150 L0,150 Z"
    />
  </svg>
      </div>
    </div>
